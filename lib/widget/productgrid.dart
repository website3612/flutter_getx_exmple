...
import 'package:flutter_getx_exmple/get_controller/product_controller.dart';
import 'package:flutter_getx_exmple/screens/product_details_screen.dart';
                    ...
                    builder: (cont) {
                      return IconButton(
                        icon: Icon(
                          Icons.shopping_cart,
                          color:
                              cartController.isCart(controller.items[index].id)
                                  ? Colors.deepOrange
                                  : Colors.grey,
                        ),
                        onPressed: () {
                          if (!cartController
                              .isCart(controller.items[index].id)) {
                            ...
                            cartController
                                .removeitem(controller.items[index].id);
                          }
                        },
                        color: Theme.of(context).accentColor,
                      );
